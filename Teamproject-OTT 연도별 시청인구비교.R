mydata <- read.csv('c:/kimsunwoo/teamprojectdata/ott.csv', header=T)
View(mydata)
...
plot(long.man$pop, type='o',xlab = 'man', ylab='percent',xlim=c(1,3), ylim=c(0,100))
